# GameJamTemplate
Hangover Sunshine game template to provide baseline setup information agnostic to any potential idea.
This template was made for Godot 4.4+, backporting to Godot 3.5 may require some touch-ups and rewriting of systems as it has not been tested there. Backporting to 4.0 - 4.2 may
also have technical issues, as some plugins rely on the new sound system that is not present in anything before 4.3. 4.3 is untested, but might work decently well.
This comes with all of our plugins we've used in larger games and game jam games.
As this is specific to HS games, you are buying into our base development style and code that would be a plugin, is not as it is core to our process.
